...
(IG, IDGI, Guided IG, BlurIG, LIG) across different models and evaluation metrics.

Default methods: IG, IDGI, Guided IG, LIG
Available methods: IG, IDGI, Guided IG, BlurIG, LIG, LIG-IDGI
...
Usage:
    ...
    python compare_methods.py --methods ig idgi guided_ig blurig lig --metrics insertion deletion
"""
...
def run_method(
    ...
    Args:
        method_name: Name of method ('ig', 'idgi', 'guided_ig', 'blurig', 'lig', 'lig_idgi')
    ...
    if method_name == 'ig':
        ...
        # BlurIG (Xu et al., CVPR 2020): Gaussian-blur path with explicit baseline.
...
def compare_methods_batch(
    ...
    for img_idx, (x, target_class, confidence, source, class_name) in enumerate(image_batch):
        ...
        if baseline_mode is None:
            # Legacy: zero in normalised space (gray-ish, not true black).
...
def main():
    ...
    parser.add_argument('--model', type=str, default='resnet50',
                        choices=['resnet50', 'vgg16', 'densenet121', 'vit_b_16',
                                 'inception_v3', 'swin_b', 'convnext_base',
